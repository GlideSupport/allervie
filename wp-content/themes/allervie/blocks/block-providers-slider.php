...
$providers_alv_layout   = $block_fields['providers_alv_layout'];
...
// Auto provider
$alrv_blk_prvdr_auto_manual      = ( isset( $block_fields['alrv_blk_prvdr_auto_manual'] ) ) ? $block_fields['alrv_blk_prvdr_auto_manual'] : null;
...
<div id="<?php echo $id; ?>" class="<?php echo $align_class . ' ' . $class_name . ' ' . $name; ?> glide-block-providers glide-block-featured-<?php echo $block_glide_name; ?> <?php echo ($providers_alv_layout) ? 'mobile-layout-providers' : ''; ?>">
	<div class="providers-section">
		...
		<?php } 
		// Auto mode start
		if( $alrv_blk_prvdr_auto_manual == 'auto' ){
