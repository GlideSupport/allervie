...
<?php } ?>
<div id="<?php echo $id; ?>" class="<?php echo $align_class . ' ' . $class_name . ' ' . $name; ?> glide-block-services glide-block-<?php echo $block_glide_name; ?>">
    ...
    <div class="servies-section">    	
        <?php if ($lp_select_posts) { ?>
            <div class="service-teaser srv-cards owl-carousel owl-theme d-flex align-items-stretch flex-wrap">
                            ...
                            <div class="srv-sngl-img">
                                ...
                                <?php if ($current_category) { ?>
                                    <div class="services-catagories">
                                        <span class="cat-btn" style="background-color: <?php echo $currentColor; ?>;"><?php echo $current_category->name; ?></span>
                                    </div>
                                <?php } ?>
                            </div>
                            <div class="srv-sngl-text">
                                <p class="heading-5"><?php the_title(); ?></p>
                                <?php if ($post_excerpt) { ?>
                                    <p class="mobile-hide"><?php echo $post_excerpt; ?></p>
                                <?php } ?>
