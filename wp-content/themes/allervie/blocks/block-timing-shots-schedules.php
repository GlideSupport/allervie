...
<div id="<?php echo $id; ?>"
	...
	$args = array(
		...
		'meta_query' => array(
			...
			array(
				...
				// Case 1: auto_manual = 1 → use manual location field
				array(
					'relation' => 'AND',
					array(
						'key' => 'alrv_cpt_cl_auto_manual',
						'value' => '1',
						'compare' => '=',
					),
					array(
				...
				// Case 2: auto_manual != 1 → use auto location field
				array(
					'relation' => 'AND',
					array(
						'key' => 'alrv_cpt_cl_auto_manual',
					...
					array(
						'key' => 'alrv_cpt_cl_slct_location_auto',
						'value' => '"' . $loc_id . '"',
						'compare' => 'LIKE',
					),
				)
	...
	if ($cl_qry->have_posts()) {
		...
		// echo $cl_description;
		?>
		<div class="closure-meassage">The location <?php echo $cl_description; ?> (<?php echo $cl_join_cat; ?>) on
			<?php echo $today_fm; ?>.
		</div>
		<?php
	}
