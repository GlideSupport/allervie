...
gulp.task(
	 ...
	 gulp.series( 'styles', 'editor-style', 'scripts', browsersync, () => {
		 ...
		 gulp.watch(
			 [ config.watchEditorStatic, '!assets/css/bundle.css', '!assets/css/bundle.css.map', '!assets/css/bundle.min.css', '!assets/css/bundle.min.css.map' ],
			 gulp.parallel( 'styles' ),
		 );
		 gulp.watch(
			 [ config.watchEditorStatic, '!assets/css/editor-style.css', '!assets/css/editor-style.css.map', '!assets/css/editor-style.min.css', '!assets/css/editor-style.min.css.map' ],
			 gulp.parallel( 'editor-style' ),
		 );
		 gulp.watch(
