...
$alrv_psn_menu_items = ( isset( $option_fields['alrv_psn_menu_items'] ) ) ? $option_fields['alrv_psn_menu_items'] : null;
...
<div id="tracking-code" style="display:none;"></div>
...
if ( $bscripts != '' ) {
	...
	<header id="header-section" class="header-section app-header">
		<!-- Header Start -->

		<div class="header-wrapper header-inner d-flex align-items-center ">
			...
			<h1 class="app-header-text"><?php _e( 'Appointment Request', 'alrv_td' ); ?></h1>
		</div>
		<!-- Header End -->
	</header>
	<!-- Header End -->
