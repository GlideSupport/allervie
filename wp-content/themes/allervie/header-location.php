...
$make_an_appointment_button = $fields['make_an_appointment_button'];

$alrv_slo_tracking_code = ( isset( $fields['alrv_slo_tracking_code'] ) ) ? $fields['alrv_slo_tracking_code'] : null;
$alrv_slo_tracking_codelink = "//scripts.iconnode.com/".$alrv_slo_tracking_code.".js";

// Secondary Navigation
$alrv_psn_menu_items = ( isset( $fields['alrv_psn_menu_items'] ) ) ? $fields['alrv_psn_menu_items'] : null;

//var_dump( $alrv_slo_tracking_codelink );
...
if ( is_singular( 'location' ) ) {
	$has_sec_nav .= ' has-single-location ';
}
...
<head>
	...
	?>
	<script src="<?php echo $alrv_slo_tracking_codelink ?>"></script>
