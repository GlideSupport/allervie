...
/**
 * Register custom CPT hubs
 */
function register_cpt_hubs() {
	// CPT Labels
	$cpt_singular_capital   = 'Hub'; // Name of the post type shown in the menu
	$cpt_plural_capital     = 'Hubs';
	$cpt_singular_lowercase = 'hub';
	$cpt_plural_lowercase   = 'hubs';

	// CPT Slug & Name
	$cpt_register_key = 'hub';  // This is the registering name of the single CPT post. (Try to keep it singular).
	$cpt_slug         = 'hub';  // This is the permalink slug of single CPT post. (Try to keep it singular).
	// The slug will become - www.website.com/hub/single-provider-name
	...
	$args   = array(
		...
		'has_archive'        => false, // Set this value for each CPT.
		'hierarchical'       => true, // Set this value for each CPT.
		'menu_icon'          => 'dashicons-rest-api', // Set this value for each CPT.
		'rewrite'            => array(
			'slug'       => $cpt_slug,
			'with_front' => true, // If required only then set this value for each CPT.
		),
...
add_action( 'init', 'register_cpt_hubs' );


/**
 * Register custom CPT PPC
 */
function register_cpt_ppc() {
	// CPT Labels
	$cpt_singular_capital   = 'PPC'; // Name of the post type shown in the menu
	$cpt_plural_capital     = 'PPC';
	$cpt_singular_lowercase = 'ppc';
	$cpt_plural_lowercase   = 'ppc';

	// CPT Slug & Name
	$cpt_register_key = 'ppc';  // This is the registering name of the single CPT post. (Try to keep it singular).
	$cpt_slug         = 'ppc';  // This is the permalink slug of single CPT post. (Try to keep it singular).
	// The slug will become - www.website.com/ppc/single-provider-name
	...
	$args   = array(
		...
		'has_archive'        => false, // Set this value for each CPT.
		'hierarchical'       => true, // Set this value for each CPT.
		'menu_icon'          => 'dashicons-money-alt', // Set this value for each CPT.
		'rewrite'            => array(
			'slug'       => $cpt_slug,
			'with_front' => true, // If required only then set this value for each CPT.
		),
...
add_action( 'init', 'register_cpt_ppc' );


/**
 * Register custom CPT: Clinic Closure
 */
function register_cpt_closure() {

	// CPT Labels
	$cpt_singular_capital   = 'Clinic Closure'; // Singular Name: Clinic Closure
	$cpt_plural_capital     = 'Closures';       // Plural Name: Closures
	$cpt_singular_lowercase = 'clinic closure';
	$cpt_plural_lowercase   = 'closures';

	// CPT Slug & Name
	$cpt_register_key = 'closure';  
	$cpt_slug         = 'closure';
	...
	$labels = array(
		...
		'not_found'             => __( 'No ' . $cpt_plural_lowercase . ' found.', 'alrv_td' ),
		'not_found_in_trash'    => __( 'No ' . $cpt_plural_lowercase . ' found in Trash.', 'alrv_td' ),
		'featured_image'        => _x( $cpt_singular_capital . ' Featured Image', 'Overrides featured image phrase', 'alrv_td' ),
		'set_featured_image'    => _x( 'Set featured image', 'Overrides set featured image phrase', 'alrv_td' ),
		'remove_featured_image' => _x( 'Remove ' . $cpt_singular_lowercase . ' image', 'Overrides remove featured image phrase', 'alrv_td' ),
		'use_featured_image'    => _x( 'Use as ' . $cpt_singular_lowercase . ' image', 'Overrides use featured image phrase', 'alrv_td' ),
		'archives'              => _x( $cpt_singular_capital . ' archives', 'Archive label', 'alrv_td' ),
		'attributes'            => _x( $cpt_singular_capital . ' attributes', 'Attributes label', 'alrv_td' ),
		'insert_into_item'      => _x( 'Insert into ' . $cpt_singular_lowercase, 'Overrides insert into post', 'alrv_td' ),
		'uploaded_to_this_item' => _x( 'Uploaded to this ' . $cpt_singular_lowercase, 'Overrides uploaded to this post', 'alrv_td' ),
		'filter_items_list'     => _x( 'Filter ' . $cpt_plural_lowercase . ' list', 'Screen reader text', 'alrv_td' ),
		'items_list_navigation' => _x( $cpt_plural_capital . ' list navigation', 'Screen reader text', 'alrv_td' ),
		'items_list'            => _x( $cpt_plural_capital . ' list', 'Screen reader text', 'alrv_td' ),
	);
...
add_action( 'init', 'register_cpt_closure' );


/**
 * Register Closure Type
 */
function closure_taxonomy() {

	// CPT Slug & Name
	$tax_parent       = 'closure'; // This is registering name of respective CPT.
	$tax_register_key = 'closure-category';  // This is the registering name of the taxonomy (Try to keep it plural).
	$tax_slug         = 'closure-category'; // This is the permalink slug of taxonomy archive (Try to keep it plural).

	$labels = array(
		'name'                       => _x( 'Closure Type', 'Taxonomy General Name', 'alrv_td' ),
		'singular_name'              => _x( 'Closure Type', 'Taxonomy Singular Name', 'alrv_td' ),
		'menu_name'                  => __( 'Closure Type', 'alrv_td' ),
		'all_items'                  => __( 'All Items', 'alrv_td' ),
		'parent_item'                => __( 'Parent Item', 'alrv_td' ),
		'parent_item_colon'          => __( 'Parent Item:', 'alrv_td' ),
		'new_item_name'              => __( 'New Item Name', 'alrv_td' ),
...
add_action( 'init', 'closure_taxonomy', 0 );