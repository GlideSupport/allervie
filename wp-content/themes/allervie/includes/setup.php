...
if ( ! function_exists( 'glide_setup_function' ) ) {
	...
	function glide_setup_function() {
		...
		register_nav_menus(
			array(
				'top-nav'          => __( 'Top Nav', 'alrv_td' ),
				'header-nav'       => __( 'Header Nav', 'alrv_td' ),
				'footer-nav-one'   => __( 'Footer Nav One', 'alrv_td' ),
				'footer-nav-two'   => __( 'Footer Nav Two', 'alrv_td' ),
				'footer-nav-three' => __( 'Footer Nav Three', 'alrv_td' ),
				'footer-nav-four'  => __( 'Footer Nav Four', 'alrv_td' ),
				'footer-nav-five'  => __( 'Footer Nav Five', 'alrv_td' ),
				'footer-nav-six'  => __( 'Footer Nav Six', 'alrv_td' ),
				'legal-nav'        => __( 'Legal Nav', 'alrv_td' ),
				'regional-hub-nav'        => __( 'Regional Hub Nav', 'alrv_td' ),
				'footer-nav-regional-hub'        => __( 'Footer Nav Regional Hub', 'alrv_td' ),
			)
		);
		...
		function nav_fallback() {
			if ( is_user_logged_in() ) {
				?> <ul>
	<li> <?php _e( 'Go to admin area to create navigation menu', 'alrv_td' ); ?></li>
</ul>
				<?php
			}
		}
...
function glide_register_required_plugins() {
	...
	$config = array(
		...
		'strings'      => array(
			'page_title'                      => __( 'Install Required Plugins', 'alrv_td' ),
			'menu_title'                      => __( 'Plugin Installer', 'alrv_td' ),
			'installing'                      => __( 'Installing Plugin: %s', 'alrv_td' ), // %s = plugin name.
			'oops'                            => __( 'Something went wrong with the plugin API.', 'alrv_td' ),
			...
			'return'                          => __( 'Return to Required Plugins Installer', 'alrv_td' ),
			'plugin_activated'                => __( 'Plugin activated successfully.', 'alrv_td' ),
			'complete'                        => __( 'All plugins installed and activated successfully. %s', 'alrv_td' ), // %s = dashboard link.
