				...
				<div class="banner-text center-align">
					...
					<div class="cdns-categories mobile-hide">
						...
						<a href="<?php echo $alrv_to_cp_conditions_page_link; ?>"
							class="button show-all-catagories white-btn ">all</a>
						<?php } ?>
						<?php
						foreach ( $conditions_terms as $condition ) {
							$current_selected_class = null;
							$condition_termid       = $condition->term_id;
							if ( $current_termid == $condition_termid ) {
								?>
						<a href="<?php echo get_term_link( $condition ); ?>"
							style="background-color: <?php echo get_field( 'alrv_tax_cco_color', $condition->taxonomy . '_' . $condition->term_id ); ?>; color:#ffffff;"
