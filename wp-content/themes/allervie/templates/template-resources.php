...
$alrv_trcho_feature_post = $fields['alrv_trcho_feature_post']; ?>
...
<section id="hero-section" class="hero-section">
	<div class="blog-hero">
		<div class="wrapper">
			...
			<?php
			global $post;
			if ( $alrv_trcho_feature_post ) {
				?>
				<?php
				foreach ( $alrv_trcho_feature_post as $key => $feature_post ) {
								$post = $feature_post;
								setup_postdata( $post );
								$pID          = $post->ID;
				...
				<div class="blog-post-box featured-post">
					<div class="blog-ft-inner two-columns align-items-center justify-content-between"> <?php if ( $image ) { ?>
	...
	<div class="wrapper">
		...
		<?php
			...
			$args = array(
				...
				// 'meta_key' => 'alrv_trcho_feature_post',
				'posts_per_page' => 9, // how many posts you need
				'paged'          => ( get_query_var( 'paged' ) ? get_query_var( 'paged' ) : 1 ),
				// 'meta_query' => array(
				// array(
				// 'key'     => 'alrv_trcho_feature_post',
				// 'value'   => '1',
				// 'compare' => '!=',
				// )
				// ),
