...
$alrv_pagetitle = glide_page_title( 'alrv_tso_title' );
...
?>
<section id="hero-section" class="hero-section service-list-hero-section aqua-gradiant-container">
	<!-- hero start -->
			...
			<div class="d-flex justify-content-center">
				<div class="banner-text center-align">
					...
					<div class="cdns-categories mobile-hide">
						...
						<a href="<?php echo $alrv_to_cp_services_page_link; ?>" class="button current white-btn all-cats">all</a>
						<?php } ?>
						<?php
